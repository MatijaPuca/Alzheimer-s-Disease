...
CREATE TABLE `healthcare` (
  ...
  KEY `fk_healthcare_User1_idx` (`healthcare_id`),
  CONSTRAINT `fk_healthcare_User1` FOREIGN KEY (`healthcare_id`) REFERENCES `user` (`user_id`)
...
INSERT INTO `healthcare` VALUES (0,3);
